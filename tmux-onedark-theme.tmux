#!/bin/bash
onedark_black="#1e1e1e"
onedark_blue="#1c7ad8"
onedark_yellow="#f9f06b"
onedark_red="#f66151"
onedark_white="#f6f5f4"
onedark_green="#8ff0a4"
onedark_visual_grey="#3d3846"
onedark_comment_grey="#deddda"
...
set "window-status-current-format" "#[fg=$onedark_black,bg=$onedark_yellow,nobold,nounderscore,noitalics]#[fg=$onedark_black,bg=$onedark_yellow,nobold] #I  #W #[fg=$onedark_yellow,bg=$onedark_black,nobold,nounderscore,noitalics]"
